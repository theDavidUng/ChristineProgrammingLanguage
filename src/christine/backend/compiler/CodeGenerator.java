...
import christine.backend.compiler.generators.*;
...
import static christine.message.MessageType.COMPILER_SUMMARY;
...
public class CodeGenerator extends Backend
{
    ...
    protected boolean isStructured(TypeSpec type)
    {
        ...
        return type.isPascalString() || (form == TypeFormImpl.ARRAY) || (form == RECORD);
    }
    ...
    protected boolean isWrapped(SymTabEntry variableId)
    {
        ...
        return (defn == VAR_PARM) && (form != TypeFormImpl.ARRAY) && (form != RECORD);
    }
    ...
    protected boolean needsCloning(SymTabEntry formalId)
    {
        ...
        return (defn == VALUE_PARM) && ((form == TypeFormImpl.ARRAY) || (form == RECORD));
    }
    ...
    protected String typeDescriptor(TypeSpec type)
    {
        ...
        while ((form == TypeFormImpl.ARRAY) && !type.isPascalString()) {
            buffer.append("[");
